...
# UN M49 Partner Mapping for Top 20 India Trade Partners & All Comtrade Codes
M49_PARTNER_MAP = {
...
def build_trade_features(comtrade_parquet: str = "data/raw/un_comtrade/india_trade_hs2_2015_2024.parquet",
    ...
    # FIX 2: Populate partnerDesc and partnerISO accurately using M49 reference map
    ...
    # FIX 1: Aggregation Bug - Group by ['partnerCode', 'cmdCode', 'flowCode', 'period'] before lag features
    ...
    # FIX 3a: Add policy_event_flag (2020, 2022, 2023)
    ...
    # Lag features (including added lag_5y)
