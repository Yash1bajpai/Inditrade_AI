...
def clean_ocr_text(text: str) -> str:
    # 1. Map typographic quotes and dashes to standard ASCII
    replacements = {
        '‘': "'", '’': "'", '“': '"', '”': '"',
        '—': '-', '–': '-', '…': '...', '°': ' deg ',
        '\ufffd': ' '
    ...
    # 2. Strip any remaining non-ASCII runs (e.g. garbled Devanagari / OCR noise glyphs)
    text = re.sub(r'[^\x00-\x7F]+', ' ', text)
    
    # 3. Clean up multiple consecutive punctuation or weird OCR artifacts like `| |` or `~~~`
