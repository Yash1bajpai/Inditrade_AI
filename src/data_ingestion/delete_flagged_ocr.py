...
def run_deletion():
    ...
    for row in all_rows:
        if row.get("doc_type") == "DGFT_OCR":
            ...
            # Condition 1: Ends with raw reference code (e.g. M-XXXX/XXX/XXXX/PC-2(A)./E-XXXX] or File No...)
            ...
            # Condition 2: Contains ".." (double period) immediately followed by "Exporters, importers, and relevant trade authorities are required to comply with these provisions"
